...
const POST_CARD_TEXT = {
  first: {
    ...
    ARM: 'Ցիկ, սիրունիկս! Այսօր շատ կարևոր օր է, չէ՞ որ այսօր ամենահամով բուլոչկի (իհարկե, կրեմ-բրյուլեով) ծննդյան օրն է!',
  },
  second: {
    RUS: 'Мне бы хотелось сегодня пожелать тебе всего самого доброго и просто поблагодарить тебя за то, что ты есть, что я имею счастье быть с тобой, общаться с тобой, видеть твою улыбку и делать все, чтобы твоя улыбка не сходила с лица!!!',
    ARM: 'Կուզենայի այսօր քեզ ամենաբարի բան ցանկանայ եւ ուղղակի շնորհակալություն հայտնել քեզ, որ կաս, որ ունեմ երջանկություն քեզ հետ լինել, շփվել, տեսնել քո ժպիտը եւ անել ամեն ինչ, որ քո ժպիտը դեմքիցդ չանհետանա!!!',
  },
  third: {
    RUS: 'Ты очень добрая, чудесная, вдохновляющая, невероятно лучезарная и удивительно искренняя 🥺🥺🥺 \n Я каждый день удивляюсь твоей сердечности и от всей души радуюсь, что в моей жизни есть такой человек (а если быть точнее - булочка), как ты!',
    ARM: 'Դու շատ բարի, հրաշալի, ոգեշնչող, անսահման պայծառ եւ անչափ անկեղծ ես 🥺🥺🥺 \n Ամեն օր զարմանում եմ քո սրտաբացության վրա եւ ամբողջ սրտով ուրախանում, որ իմ կյանքում կա այնպիսի մարդ (իսկ ավելի ճիշտ՝ ասել - բուլոչկա), ինչպիսին դու ես!',
  },
  fourth: {
    RUS: 'Не знаю, как ты смогла сохранить с годами тот свет, что несешь в себе и даешь другим, но я благодарен тебе и твоей семье, что ты,  несмотря ни на что, осталась такой нежной, чуткой, воздушной зефиркой! Я думал, что таких людей не бывает...',
  ...
  fifth: {
    ...
    ARM: 'Ես քեզ հետ ինձ շատ լավ եմ զգում, եւ անչափ ուրախ եմ, որ իմ կյանքում հայտնվել է այնպիսի մարդ, ում կարող եմ ամբողջ սրտով ասել այս բոլոր բառերը! Այսպիսի պահերին ես ինձ զգում եմ երջանիկ ✨✨✨',
  },
  sixth: {
    RUS: 'Еще раз поздравляю с твоим днем рождения ♥️♥️♥️\nПусть у тебя и твоей семью все будет хорошо, а со своей стороны я приложу все усилия, чтобы сделать твою жизнь лучше!\nОбещаю!!!\n P.S. Не забудь посмотреть вниз!',
