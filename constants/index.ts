...
const POST_CARD_TEXT = {
  ...
  third: {
    ...
    ARM: 'Դու շատ բարի, հրաշալի, ոգեշնչող, անսահման պայծառ եւ անչափ անկեղծ ես 🥺🥺🥺\nԱմեն օր զարմանում եմ քո սրտաբացության վրա եւ ամբողջ սրտով ուրախանում եմ, որ իմ կյանքում կա այնպիսի մարդ (իսկ ավելի ճիշտ՝ ասաց - բուլոչկա), ինչպիսին դու ես!',
